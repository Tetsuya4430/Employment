...
void Particle::SetEye(XMFLOAT3 eye)
{
	Particle::eye = eye;
...
void Particle::SetTarget(XMFLOAT3 target)
{
...
void Particle::CameraMoveVector(XMFLOAT3 move)
{
...
void Particle::InitializeCamera(int window_width, int window_height)
{
	// ビュー行列の生成
...
void Particle::UpdateViewMatrix()
{
	// ビュー行列の更新
